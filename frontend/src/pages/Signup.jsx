...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            login(data);
            toast.success(`Welcome, ${data.name.split(' ')[0]}! Your account has been created.`);
            navigate('/');
        } catch (error) {
    ...
    return (
        <div className="container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '80vh' }}>
            ...
            >
                ...
                <p style={{ color: 'var(--text-muted)', textAlign: 'center', marginBottom: '30px' }}>Sign up for Momo Plaza</p>

                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        <label style={{ fontSize: '14px', fontWeight: '500' }}>Full Name</label>
                        <div style={{ position: 'relative' }}>
                            <User size={18} style={{ position: 'absolute', left: '15px', top: '50%', transform: 'translateY(-50%)', color: 'var(--text-muted)', zIndex: 1 }} />
                            <input
                                type="text"
                                name="name"
                                autoComplete="name"
